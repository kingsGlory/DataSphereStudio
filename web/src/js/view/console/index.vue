  ...
  <div class="console-page">
    ...
    <div class="console-page-content">
      <div class="console-page-content-head">
        <div>
          <span class="console-page-content-title">{{
            $t("message.console.title")
          }}</span>
          <span class="console-page-content-info">{{
            $t("message.console.info", { num: "13" })
          }}</span>
        </div>
      </div>
...
export default {
  data() {
    return {
      sideNavList: [
        {
          key: "1",
          name: this.$t("message.console.sideNavList.function.name"),
          padding: 0,
          icon: "ios-options",
          children: [
            {
              key: "1-1",
              name: this.$t(
                "message.console.sideNavList.function.children.globalHistory"
              ),
            ...
            },
            {
              key: "1-2",
              name: this.$t(
                "message.console.sideNavList.function.children.resource"
              ),
            ...
            },
            {
              key: "1-3",
              name: this.$t(
                "message.console.sideNavList.function.children.setting"
              ),
            ...
            },
            {
              key: "1-4",
              name: this.$t(
                "message.console.sideNavList.function.children.dateReport"
              ),
            ...
            },
            {
              key: "1-5",
              name: this.$t(
                "message.console.sideNavList.function.children.globalValiable"
              ),
              path: "/console/FAQ"
            }
          ]
      ...
      breadcrumbFirstName: this.$t("message.console.sideNavList.function.name"),
  ...
  methods: {
    handleCellClick(index) {
      ...
      if (window.location.href.includes("/console/globalHistory") && activedCell.path === '/console/globalHistory' && this.$refs.child.isLogModuleShow) {
        //点击全局历史从日志详情返回到列表
        this.$refs.child.back();
      } else {
        this.$router.push({
    ...
    if (to.name === "FAQ" && from.name === "Home") {
      next(vm => {
        vm.breadcrumbFirstName = this.$t(
          "message.console.sideNavList.function.name"
        );
